...
<div id="page-header" <?php echo $soho_theme_active ? $header_image : ''; ?>>
	<h2><?php the_title(); ?></h2>
</div>
				...
				<form class="booking-form" action="<?php echo get_permalink($quitenicebooking->settings['step_1_page_id']); ?>" method="POST">
					<div class="room-price-widget">
						...
						<h3 class="price">
							...
							echo Quitenicebooking_Utilities::format_price(Quitenicebooking_Utilities::float_to_user_price($lowest_price, $quitenicebooking->settings, TRUE), $quitenicebooking->settings);
							?>
						</h3>
