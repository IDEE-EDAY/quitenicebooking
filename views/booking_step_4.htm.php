...
<div class="booking-main-wrapper">
	...
	<div class="booking-main">
		...
		<h4 class="title-style4"><?php _e('Reservation Complete', 'quitenicebooking'); ?><span class="title-block"></span></h4>
		...
		<?php if ( isset( $quitenicebooking_errors ) && count( $quitenicebooking_errors ) > 0 ) { ?>
			...
			<?php } ?>
		<?php } else { ?>
			<p><?php echo $quitenicebooking_booking_success_message; ?></p>
		<?php } ?>
		...
		<?php if ($quitenicebooking_payment_method == 'bank_transfer') { ?>
			<div class="payment_details" id="payment_details_bank_transfer">
			<h4 class="title-style4"><?php _e('Bank Transfer Information', 'quitenicebooking'); ?><span class="title-block"></span></h4>
			<p><?php echo nl2br($quitenicebooking_bank_transfer_details); ?></p>
			</div>
		<?php } ?>
	...
	<div class="booking-side clearfix">
		...
		<div class="price-details">
			...
			<?php if ($accept_deposit && $quitenicebooking_deposit_type == 'percentage') { ?>
				...
				<h3 class="price"><?php echo Quitenicebooking_Utilities::format_price(Quitenicebooking_Utilities::float_to_user_price($quitenicebooking_deposit, $this->settings, TRUE), $this->settings); ?></h3>
				<hr class="total-line" />
			...
			<div id="price_break_hotel_room_all" class="hide">
				...
				<div class="page-content">
					...
					<table><tbody>
						<?php foreach ($quitenicebooking_services as $s) { ?>
					...
					<table><tbody>
						<tr>
							...
							<td><?php echo Quitenicebooking_Utilities::format_price(Quitenicebooking_Utilities::float_to_user_price($quitenicebooking_total, $this->settings, TRUE), $this->settings); ?></td>
						</tr>
					</tbody></table>
				<!-- END .page-content -->
				</div>
